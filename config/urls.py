...
urlpatterns = [
    ...
    path('renders/<int:render_id>/markers/', render_markers, name='render_markers'),
    path(
        'renders/<int:render_id>/markers/create-set/',
        create_marker_set,
        name='create_marker_set',
    ),
    path(
        'renders/<int:render_id>/markers/publish/',
        publish_render_markers,
        name='publish_render_markers',
    ),
    path(
        'marker-sets/<int:marker_set_id>/edit/',
        edit_marker_set,
        name='edit_marker_set',
    ),
    path(
        'marker-sets/<int:marker_set_id>/delete/',
        delete_marker_set,
        name='delete_marker_set',
    ),
    path(
        'marker-sets/<int:marker_set_id>/markers/create/',
        create_marker,
        name='create_marker',
    ),
    path('markers/<int:marker_id>/edit/', edit_marker, name='edit_marker'),
    path('markers/<int:marker_id>/delete/', delete_marker, name='delete_marker'),
